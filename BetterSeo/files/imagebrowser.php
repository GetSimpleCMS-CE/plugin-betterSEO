						...
						<tbody>
							...
							<tr class="All">
								<td class="" colspan="5">
									...
									<a href="imagebrowser.php?path=<?php echo $p; ?>&amp;func=<?php echo $func; ?>&amp;w=<?php echo $w; ?>&amp;h=<?php echo $h; ?>&autoclose=1&CKEditor=post-content&func=<?php echo $_GET['func']; ?>&count=<?php echo $_GET['count']; ?>" title="<?php echo $upload['name']; ?>"><strong><?php echo $upload['name']; ?></strong></a>
								</td>
							</tr>
							<?php
									}
							...
							<tr class="All images">
								...
								<td>
									<a class="primarylink" href="javascript:void(0)" title="<?php i18n('SELECT_FILE') . ': ' . htmlspecialchars(@$upload['name']); ?>" onclick="<?php echo $onclick; ?>"> <?php echo htmlspecialchars($upload['name']); ?></a>
									<p>
